...
THREBUF	EQU	04000H		* SOME BUFFER THAT WAS AT 3000H
TBEND	EQU	050H		* THE END OF THREBUF
...
*			          SOME TEXT STRINGS TO READ AND WRITE BUFFERS
	DS	179		* PUT IT AT 0x5100
	ERRNZ	*-121000A
	DB	'Now is the time for all good men to come to the aid of their country.',200Q
	DS	186	* PUT IT AT 0x5200
	ERRNZ	*-122000A
...
FILLLP	EQU	*
	...
	LXI	H,DATABUF	* FILL 2000 TO 2FFF WITH 00H
FILLLP1 EQU	*
	MVI	M,00H
	INX	H
	MOV	A,H
